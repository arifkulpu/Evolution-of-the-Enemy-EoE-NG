...
### Kurulum
- Herhangi bir Mod yöneticisi (MO2, Vortex) ile kurabilirsiniz.
1. `EvolutionOfTheEnemyNG.dll` dosyasını `Data/SKSE/Plugins/` klasörüne kopyalayın. (Ya da ZIP olarak mod yöneticisine yükleyin).
2. Oyunu SKSE üzerinden başlatın.
3. Mod ilk açılışta kendi `.ini` dosyasını otomatik olarak oluşturacaktır. İsterseniz bu dosyayı açıp ayarları özelleştirebilirsiniz.
